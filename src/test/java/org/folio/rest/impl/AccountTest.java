...
//      Response response = postData("vendors/accounts", accountSample);
...
//      getData("vendors/accounts").then().log().ifValidationFails()
//        .statusCode(200)
//        .body("total_records", equalTo(1));
//
//      logger.info("--- mod-vendors-test: Fetching account with ID: "+ accountSampleId);
//      getDataById("vendors/accounts", accountSampleId).then().log().ifValidationFails()
//        .statusCode(200)
...
//      response = putData("vendors/accounts", accountSampleId, catJSON.toString());
//      response.then().log().ifValidationFails()
//        .statusCode(204);
//
//      logger.info("--- mod-vendors-test: Fetching account with ID: "+ accountSampleId);
//      getDataById("vendors/accounts", accountSampleId).then()
//        .statusCode(200).log().ifValidationFails()
//        .body("description", equalTo("Gift"));
//
//      logger.info("--- mod-vendors-test: Deleting account with ID ... ");
//      deleteData("vendors/accounts", accountSampleId).then().log().ifValidationFails()
//        .statusCode(204);
//
//    }
//    catch (Exception e) {
