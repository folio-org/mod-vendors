...
public class DeleteContactCategoryByIdTransaction extends BaseTransaction<Category_> {
  private UUID category_id;
  private String tenantId;

  public static DeleteContactCategoryByIdTransaction newInstance (String uuid, String tenantId) {
    return new DeleteContactCategoryByIdTransaction(uuid, tenantId);
  }

  private DeleteContactCategoryByIdTransaction(String uuid, String tenantId) {
